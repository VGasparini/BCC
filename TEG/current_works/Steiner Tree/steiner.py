...
if __name__ == '__main__':
    if input('Deseja gerar um grafo aleatóriamente? s ou n\n ->') == 's':
        ...
        g = connect_components(get_connected_components(load_graph(input("Digite o nome do arquivo\n ->"))))
        gen_timer = 0
    terminals = pick_random_terminals(g, int(input("Digite a quantidade de nós terminais\n ->")))
